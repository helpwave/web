...
const GridBox = ({ children, heading, childrenSurroundingClassName = '' }: PropsWithChildren<{ heading?: ReactNode, childrenSurroundingClassName?: string }>) => (
  <div className={tw('relative w-fit p-14')}>
    ...
    <div className={tw('absolute inset-x-0  inset-y-14 border-t-2 border-b-2 border-dashed border-[#8E75CE] z-0 pointer-events-none')} />
    <div className={tw('absolute inset-x-14 inset-y-0  border-l-2 border-r-2 border-dashed border-[#8E75CE] z-0 pointer-events-none')} />
