        ...
        <div className="hidden w-full md:block md:w-auto " id="navbar-default">
          <ul className="flex flex-col p-4 md:flex-row lg:flex-row list-none lg:ml-auto">
            <li className="hover:underline nav-item">
              <a className="px-3 py-2 flex items-center text-xs font-bold leading-snug hover:opacity-75" href="#">
            ...
            <li className="hover:underline nav-item">
              <a className="px-3 py-2 flex text-white items-center text-xs font-bold leading-snug text-white hover:opacity-75" href="#">
                  <span className="ml-2">
                    Team
                  </span>
              </a>
