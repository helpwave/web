...
const MenuItem = ({
  ...
  <div
    className={clsx('block px-3 py-1 hover:bg-slate-100', {
    ...
    >
      ...
      {isOpen ? (
        <div ref={menuRef} onClick={e => e.stopPropagation()}
             className={clsx('absolute top-full mt-1 py-2 w-60 rounded-lg bg-white ring-1 ring-slate-900/5 text-sm leading-6 font-semibold text-slate-700 shadow-md z-[1]', {
