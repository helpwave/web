...
const Button = ({
  ...
  <button
    ...
    className={tx('py-2 px-4 text-sm font-medium focus:outline-none', className, {
      ...
      'text-white bg-hw-positive-500    hover:bg-hw-positive-600    focus:ring-hw-positive-500': variant === 'primary' && color === 'positive', // TODO: green
      ...
      'text-indigo-500 bg-indigo-200 hover:bg-indigo-300 focus:ring-indigo-200': variant === 'secondary' && color === 'accent', // TODO use hw-primary instead of indigo
      ...
      'text-indigo-500 hover:underline focus:ring-indigo-200': variant === 'tertiary' && color === 'accent', // TODO use hw-primary instead of indigo
