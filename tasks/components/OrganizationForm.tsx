...
export const OrganizationForm = ({
  ...
  function validateEmailWithOrganization(organization: OrganizationGeneralInfoDTO) {
  ...
  const emailErrorMessage: string | undefined = validateEmailWithOrganization(organization)
