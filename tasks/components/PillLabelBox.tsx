...
const PillLabelBox = ({ unscheduled, inProgress, done }: PillLabelBoxProps) => {
  ...
  return (
    <div className={tw('flex flex-row h-6')}>
      ...
      <div className={tw(`w-0 h-0 border-hw-label-1-background border-solid border-r-transparent border-b-transparent ${borderWidth}`)} />
      <div className={tw(`w-0 h-0 border-hw-label-2-background border-solid border-l-transparent border-t-transparent ${borderWidth}`)} />
      ...
      <div className={tw(`w-0 h-0 border-hw-label-2-background border-solid border-r-transparent border-b-transparent ${borderWidth}`)} />
      <div className={tw(`w-0 h-0 border-hw-label-3-background border-solid border-l-transparent border-t-transparent ${borderWidth}`)} />
