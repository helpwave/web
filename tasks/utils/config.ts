...
const configSchema = z.object({
  ...
  NEXT_PUBLIC_PLAYSTORE_LINK: z.string().url().default('https://play.google.com/store/apps/details?id=de.helpwave.tasks'),
  NEXT_PUBLIC_APPSTORE_LINK: z.string().url().default('https://apps.apple.com/de/app/helpwave-tasks/id6472594365'),
